...
# --------------------------------------------------------------------------------------------------
# Usage   : awk [-v STEP=VAL] -f lighten_kml.awk inputFileName > outputFileName
# Example : awk -v STEP=5 -f lighten_kml.awk logsVol.kml > logsVolAllege.kml
# --------------------------------------------------------------------------------------------------
